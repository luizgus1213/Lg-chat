(() => {
  ...
  window.LGChat.state = {
    ...
    loadingChatsPromise: null,
    forceNextChatReload: false,
    allUsers: [],
    selectedChat: null,
    openingChatId: null,
    openChatAbortController: null,
    pendingChatListMessages: [],
    pendingChatListTimer: null,
    messageCacheByChat: {},
    messagePaginationByChat: {},
    messagesScrollBound: false,
    pendingReadByChat: {},
    pendingReadTimers: {},
    statusGroups: [],
